...
import com.booking.room.model.JwtRequest;
import com.booking.room.model.JwtResponse;
import com.booking.room.service.JwtUserDetailsService;
import com.booking.room.service.RoomReservationService;
import com.booking.room.util.JwtTokenUtil;
...
public class JwtAuthenticationController {
    ...
    public ResponseEntity<?> createAuthenticationToken(@RequestBody JwtRequest authenticationRequest) throws Exception {
        ...
        LOG.info("USERDETAILS USER "+userDetails.getUsername());
        LOG.info("USERDETAILS PASS "+userDetails.getPassword());
